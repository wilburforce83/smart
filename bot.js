...
// to be used with https://www.npmjs.com/package/relay-raspberry 
...
setTimeout(function () { // run checking cycle
  rss.checkWeather()
  setInterval(rss.checkWeather, 1000 * 60  * global.frequency); // converts minutes into milliseconds for working with node.
}, 5000);
